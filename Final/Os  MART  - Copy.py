...
def login():
    ...
    def pay():
        ...
        def cards():
            ...
            Entry(root, textvariable=v, width=5, border=3).place(x=250, y=195)
    ...
    def show():
        ...
        Button(root,text="CHECKOUT",border=3, width=20,font="Constantia 9 italic",
    ...
    def order():
        ...
        if var.get() == "1":
            ...
            Button(top, text="Add to Cart", fg="blue", border=5, font="Constantia 9 italic",
                   command=lambda: insert(2, "Macbook", clicked.get(),199900)).place(x=70, y=270)
            ...
            Button(top, text="Add to Cart", fg="blue", border=5, font="Constantia 9 italic",
                   command=lambda: insert(1, "Airpods", clicked.get(),20999)).place(x=70, y=270)
            Button(top, text="Buy Now!", bg="orange", fg="black", border=3, width=20, command=det,
                   font="Constantia 9 italic").place(x=275, y=201)
            ...
            Button(top, text="Add to Cart", fg="blue", border=5, font="Constantia 9 italic",
                   command=lambda: insert(3, "OnePlus", clicked.get(),59999)).place(x=70, y=290)
            Button(top, text="Buy Now!", bg="orange", fg="black", border=3, width=20,command=det,
                   font="Constantia 9 italic").place(x=275, y=201)
...
Label(root, text="Username", font="Constantia 15 italic", fg="blue").place(x=5, y=150)
Label(root,text="Password:",font="Constantia 15 italic", fg="blue",bg="light grey").place(x=5, y=230)
